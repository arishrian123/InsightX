        ...
        securitiesDBCollection.addSnapshotListener { (documentSnapshot, err) in
                    ...
                    documentSnapshot!.documentChanges.forEach { diff in
                        ...
                        if (diff.type == .added) {
                            ...
                            let securitiesData = Securities(Company: diff.document.get("Company") as? String ?? "", Currency: diff.document.get("Currency") as? String ?? "", Price1: diff.document.get("Price1") as? Int ?? 0, Price1Date: diff.document.get("Price1Date") as? String ?? "", Price2: diff.document.get("Price2") as? Int ?? 0, Price2Date: diff.document.get("Price2Date") as? String ?? "", Price3: diff.document.get("Price3") as? Int ?? 0, Price3Date: diff.document.get("Price3Date") as? String ?? "", Price4: diff.document.get("Price4") as? Int ?? 0, Price4Date: diff.document.get("Price4Date") as? String ?? "", Price5: diff.document.get("Price5") as? Int ?? 0, Price5Date: diff.document.get("Price5Date") as? String ?? "", ShortDescription: diff.document.get("ShortDescription") as? String ?? "", securityID: diff.document.documentID)
